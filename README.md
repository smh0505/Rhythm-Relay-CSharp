...
가장 최근 버전인 [Ver.1.0](https://github.com/smh0505/Rhythm-Relay-CSharp/releases/tag/v.1.0)과 비교해 다음과 같은 변경점이 있습니다.
1. 타이머 별도의 창으로 분리
  - 이제 곡 수가 0이 되어도 퇴근 버튼을 누르지 않으면 퇴근이 되지 않습니다.
2. 퇴근 SFX 볼륨 및 음소거 추가
## Special Thanks
